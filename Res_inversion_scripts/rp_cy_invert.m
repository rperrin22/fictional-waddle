function [param_out] = rp_cy_invert(appres_real,layertops,r1_initial,rho1_initial,rho2_initial,dr,dz,shot_sequence_file,param_flag,dmod)
...
switch param_flag
    case 1
        ...
        perturb = ((J'*J)\(J'*(appres_real - appres_temp)));
    case 2
